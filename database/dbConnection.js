...
//Create users table
//db.run('CREATE TABLE users ("userId" INTEGER NOT NULL,"username" TEXT, "email" TEXT, "password" TEXT, PRIMARY KEY("userId" AUTOINCREMENT))');

//Create files table
//db.run('CREATE TABLE "files" ("fileId"  INTEGER NOT NULL, "title"  TEXT, "description"  TEXT, "createdBy"  INTEGER, FOREIGN KEY("createdBy") REFERENCES "users"("userId"), PRIMARY KEY("fileId" AUTOINCREMENT))');
